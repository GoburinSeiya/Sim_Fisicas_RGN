...
int main() {
    ...
    b2Vec2 gravity(0.0f, -24.79f); // La gravedad es 1/6 veces menos que en la tierra
    ...
    fixtureDef.friction = 0.9f; //La atmosfera es tan poco densa que la fricción del aire se vuelve despreciable
