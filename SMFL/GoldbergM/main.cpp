...
int main() {
    ...
    //Sphere balanceBall(world, 835,550, 1.0f);
    Cube ramAnchor(world, 50, 560, 10.0f, 10.0f, false);
    ...
    //region Ram Limiter
    b2PrismaticJointDef ramMovementRange;
    ...
    //region Weld Dominoes
    b2WeldJointDef domino1Weld;
    ...
    while (window.isOpen()) {
        ...
        //ball2.draw(window);
        //balanceBall.draw(window);
        //ramAnchor.draw(window);
        ram.draw(window);
